...
import CanvasCards from '../components/CanvasCardsRarea';
...
function CardStandardTemplate( {data} ) {
    ...
    return ( 
        <div>
                ...
                <div className={cardStyles.interactiveAssets}>
                    ...
                    <div className={cardStyles.dataCont}>
                        ...
                        <div className={cardStyles.infoPersonal}>
                            <h1 style={{color: "black",}}>Rarea Studio</h1>
                            ...
                            <a href={contacts.publicURL} download={contacts.publicURL} target="_blank" rel="noreferrer" aria-label="add contact" className={cardStyles.contactButton}><p>Add to contacts</p></a>
                        </div>
                    </div>
                    <div className={cardStyles.iconsCont}>
                        <a href={"https://www.instagram.com/rareastudio/"} target="_blank" rel="noreferrer" aria-label="instagram"><div className={`${cardStyles.iconBC} ${cardStyles.instagramBC}`} placeholder="instagram"></div></a>
                        ...
                        <a href={"https://rareastudio.com/"} target="_blank" rel="noreferrer" aria-label="web"><div className={`${cardStyles.iconBC} ${cardStyles.webBC}`} placeholder="web"></div></a>
            ...
            <CanvasCards color={color} logo={'/rarea_logo.glb'}/>
        </div>
     );
}
...
export const query = graphql`
  query RareaCardData($slug: String) {
